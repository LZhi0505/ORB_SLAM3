...
public:
    ...
    Tracking(System *pSys, ORBVocabulary *pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Atlas *pAtlas, KeyFrameDatabase *pKFDB, const string &strSettingPath, const int sensor,
...
protected:
    ...
    cv::Mat mK; // 内参矩阵
    Eigen::Matrix3f mK_;
    cv::Mat mDistCoef; // 包含四个畸变参数 k1, k2, p1, p2
    float mbf;
    float mImageScale;
    ...
    double time_recently_lost; // 默认为5s
