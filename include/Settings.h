...
public:
    ...
    //! 疑似有误，右目相机使用左目的畸变参数，但是配置文件中的畸变参数不同
...
private:
    template <typename T> T readParameter(cv::FileStorage &fSettings, const std::string &name, bool &found, const bool required = true) {
