...
//! ./mono_tum_vi ./small_voc.bin ./ShouJing_ke_kan.yaml /home/liuzhi/下载/Dataset/ShouJing/ShouJing_ke/cam0/data ./EuRoC_TimeStamps/ShouJing_ke.txt ShouJing_ke_kan
int main(int argc, char **argv) {
    ...
    if (argc < 4) {
        cerr << endl
             << "Usage: ./mono_tum_vi path_to_vocabulary path_to_settings path_to_image_folder_1 path_to_times_file_1 (path_to_image_folder_2 path_to_times_file_2 ... path_to_image_folder_N "
